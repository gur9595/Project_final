...
<div>
   <div id="field" class="three_quarter first">
      <table 
         style="height: ::;;; width: 100%; background: url(http://static.footballuser.com/images/field.jpg); background-size: 100% 100%; background-repeat: no-repeat;">
   ...
   <div class="one_quarter" style="display: inline;">
      <div class="">
      <br class="clear" />
