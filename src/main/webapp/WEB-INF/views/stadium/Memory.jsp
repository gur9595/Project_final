                                            ...
                                            <div class="comment-widgets scrollable">
                                                <table>
                                                    <tr style="border-bottom: 3px solid #036">
                                                    	<th>날짜</th>
                                                        <th>빌린 팀장</th><!-- 클릭하면 클럽 정보 나옴 -->
                                                    	<th>시간</th>
                                                      
                                                    </tr>
													<c:forEach items="${viewRow }" var="row" varStatus="status"> 
														<tr>
															<th>${row.g_date }</th>
															<th><a href="${pageContext.request.contextPath }/club/clubView.do?c_idx=${row.c_idx}">${row.c_name }</a></th>
															<th>${row.g_time }</th>
