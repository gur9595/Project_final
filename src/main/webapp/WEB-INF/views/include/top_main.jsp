...
<div class="row" style="padding-top: 25px; padding-bottom: 25px;">    
   ...
   <div class="menu-common" style="width: 550px;">  
      <nav id="mainav" class="right text-right"> 
         <ul class="cl ear" style="font-size: 10px; color: white;">
   ...
   <div class="menu-common">
      <nav id="mainav" class="left text-left">
         <ul class="cl ear" style="font-size: 10px; text-align: center;">
             <li style="font-size: 30px; display: inline-block;">
                <a href="${pageContext.request.contextPath }">
                   <!--  b-pro로고 -->
                   <img src="${pageContext.request.contextPath }/resources/img/bprologo_white.png" style = "width:auto;height:50px;"/>
                </a>
             </li>
         </ul>
      </nav>
