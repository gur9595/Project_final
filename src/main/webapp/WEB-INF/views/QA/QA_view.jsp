...
<div class="row mb-3">
	...
	<button class="btn btn-secondary" onclick="location.href='qnaEdit.do?b_idx=${viewRow.b_idx}';">수정하기</button>
	<!-- 회원제게ㅣ판에서 삭제처리는 별도의 폼이 필요없이 , 사용자에 대한
	인증처리만 되면 즉시 삭제처리한다. -->
	<button class="btn btn-success" onclick="javascript:deleteRow(${viewRow.b_idx});">삭제하기</button>
	</c:if>
</div>
